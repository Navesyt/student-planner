export const translations = {
  fr: {
    ...
    done:'Terminé', noGrades:'Aucune note', exportData:'Exporter les données', importData:'Importer une sauvegarde', backup:'Sauvegarde des données', backupHint:'Exporte un fichier JSON pour transférer toutes tes données vers un autre appareil.', importWarning:"L’importation remplacera les données actuellement présentes sur cet appareil.", importSuccess:'Données importées avec succès.', language:'Langue',
  ...
  en: {
    ...
    done:'Done', noGrades:'No grades', exportData:'Export data', importData:'Import backup', backup:'Data backup', backupHint:'Export a JSON file to transfer all your data to another device.', importWarning:'Importing will replace the data currently stored on this device.', importSuccess:'Data imported successfully.', language:'Language', groups:'My groups',
